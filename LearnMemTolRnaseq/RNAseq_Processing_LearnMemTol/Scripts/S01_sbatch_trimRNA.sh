...
module load py-cutadapt/py-cutadapt-1.9.1
module load pigz/pigz-2.3.4

 
# Science goes here:

COMMANDA=`head -n ${SLURM_ARRAY_TASK_ID} "/storage/hpc/group/kinglab/Patricka/Learn_Mem/rna-seq_data_raw/S01_Trim_LearnMemRNA.txt" | tail -n 1` 
$COMMANDA
