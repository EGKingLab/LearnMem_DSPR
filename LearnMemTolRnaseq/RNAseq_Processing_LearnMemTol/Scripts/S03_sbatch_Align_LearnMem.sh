...
COMMANDA=`head -n ${SLURM_ARRAY_TASK_ID} "/storage/hpc/group/kinglab/Patricka/Learn_Mem/rna-seq_data_raw/Align_cmds_LearnMemRNA.txt" | tail -n 1` 
$COMMANDA
